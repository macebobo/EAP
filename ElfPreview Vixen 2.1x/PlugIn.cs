...
{
	/// <summary>
	/// Elf Preview Output PlugIn For Vixen 2.1.x
	/// </summary>
	public class PlugIn : Vixen.IEventDrivenOutputPlugIn
	{
		...
		{
			get { return "Elf Preview Output PlugIn for Vixen 2.1.x"; }
		}
		...
		public void Setup()
		{
			...
			try
			{
				...
				LoadingProfile = new BaseProfile(typeof(ElfProfiles.Vixen.Vixen21x));
		...
		/// </summary>
		/// <returns>Returns a list of forms that the plug-in needs to have injected into Vixen's MDI interface.</returns>
