	...
	public class MruStripMenu
	{
		...
		public void LoadFromRegistry()
		{
			if (registryKeyName != null)
			{
				...
				RegistryKey regKey = Microsoft.Win32.Registry.CurrentUser.OpenSubKey(registryKeyName);
				if (regKey != null)
				{
		...
		public void SaveToRegistry()
		{
			if (registryKeyName != null)
			{
				...
				RegistryKey regKey = Microsoft.Win32.Registry.CurrentUser.CreateSubKey(registryKeyName);
				if (regKey != null)
				{
