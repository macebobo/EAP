...
namespace ElfCore.Tools
{
	...
	public class SingingFaceTool : MultiChannelBase, ITool
	{
		...
		{
			this.ID = (int)ToolID.SingingFace;
		...
		protected override void AttachEvents(bool attach)
		{
			...
			if (attach)
			{
				EyeChannels.SelectedIndexChanged += new EventHandler(EyeChannels_SelectedIndexChanged);
				MouthChannels.SelectedIndexChanged += new EventHandler(MouthChannels_SelectedIndexChanged);
			}
			else
			{
				EyeChannels.SelectedIndexChanged -= this.EyeChannels_SelectedIndexChanged;
				MouthChannels.SelectedIndexChanged -= this.MouthChannels_SelectedIndexChanged;
			}
